...
def predict_route():
    ...
    cleaned_data = data_cleaner.cleaned_data
    print(cleaned_data)
    nero_predictions = None
    Nero_predictions_plot=None
    # Preprocess the data
    try:
        ...
        x_train_scaled, x_test_scaled, y_train, y_testy = umsatz_model.load_and_preprocess_data(cleaned_data)
        ...
        Nero_predictions_plot = umsatz_model.plot_resultsNero(y_testy, Nero_predictions)
    except:
        print("nero  is sad")
        traceback.print_exc()
    ...
    return jsonify(predictions=results.to_dict(), plot_url=plot_url, results_html=results_html,nero=Nero_predictions_plot)
